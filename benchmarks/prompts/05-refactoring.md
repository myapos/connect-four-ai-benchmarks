You are a Staff Frontend Engineer performing a pull request review.

Refactor the following Vue 3 + TypeScript component.
...
- Keep the component as a single Vue Single File Component.
- Improve readability.
...
- Do not optimize performance unless it directly improves readability.
- Keep the generated code production-ready.
...
Provide a numbered list explaining every important refactoring decision.

## Trade-offs

Mention any trade-offs introduced by your refactoring.

## Improvements intentionally NOT made

List improvements you deliberately avoided because they would change behavior, architecture, or exceed the scope of a refactor.
